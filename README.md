...
- As a data set folder can have many files processing them one by one may take a alot of time to counter this threading is use to process each file in parallel
